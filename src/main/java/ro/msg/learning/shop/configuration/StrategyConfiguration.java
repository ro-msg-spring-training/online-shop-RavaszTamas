...
public class StrategyConfiguration {
  ...
  OrderDeliveryStrategy orderDeliveryStrategy(
    ...
    if (strategy.equals("abundant")) return new MostAbundantOrderDeliveryStrategy(stockRepository);
    else if (strategy.equals("singleLocation"))
      return new SingleLocationOrderDelivery(locationRepository);
    else return new SingleLocationOrderDelivery(locationRepository);
  }
}
