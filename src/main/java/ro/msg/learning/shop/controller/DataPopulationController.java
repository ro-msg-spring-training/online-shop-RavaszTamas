...
public class DataPopulationController {
    ...
    public ResponseEntity<String> populateDatabase() {
        ProductCategory productCategoryOne = productCategoryRepository.save(ProductCategory.builder().name(CAT_1).description(DESCRIPTION_1).build());
        ProductCategory productCategoryTwo = productCategoryRepository.save(ProductCategory.builder().name(CAT_2).description(DESCRIPTION_2).build());
        ...
        Location locationOne = locationRepository.save(Location.builder()
                .name("First location")
                .address(Address.builder().streetAddress(STREET_1).city(CITY_1).county(COUNTY_1).country(COUNTRY_1).build())
                .build());
        Location locationTwo = locationRepository.save(Location.builder()
                .name("Second location")
                .address(Address.builder().streetAddress(STREET_2).city(CITY_2).county(COUNTY_2).country(COUNTRY_2).build())
                .build());
        Location locationThree = locationRepository.save(Location.builder()
                .name("Third location")
                .address(Address.builder().streetAddress(STREET_3).city(CITY_3).county(COUNTY_3).country(COUNTRY_3).build())
                .build());
        Product productOne = productRepository.save(Product.builder()
                .supplier(supplierOne).productCategory(productCategoryOne).name(PRODUCT_1).description(DESC_1)
                .price(new BigDecimal(BIG_DECIMAL_VALUE)).weight(WEIGHT).imageUrl(WWW_APPLE_1_COM)
                .build());
        Product productTwo = productRepository.save(Product.builder()
                .supplier(supplierOne).productCategory(productCategoryTwo).name(PRODUCT_2).description(DESC_2)
                .price(new BigDecimal(BIG_DECIMAL_VALUE)).weight(WEIGHT).imageUrl(WWW_APPLE_2_COM)
                .build());
        Product productThree = productRepository.save(Product.builder()
                .supplier(supplierTwo).productCategory(productCategoryTwo).name(PRODUCT_3).description(DESC_3)
                .price(new BigDecimal(BIG_DECIMAL_VALUE)).weight(WEIGHT).imageUrl(WWW_APPLE_3_COM)
                .build());
        Product productFour = productRepository.save(Product.builder()
                .supplier(supplierTwo).productCategory(productCategoryOne).name(PRODUCT_4).description(DESC_4)
                .price(new BigDecimal(BIG_DECIMAL_VALUE)).weight(WEIGHT).imageUrl(WWW_APPLE_4_COM)
                .build());
        productRepository.save(Product.builder()
                .supplier(supplierTwo).productCategory(productCategoryOne).name(PRODUCT_5).description(DESC_5)
                .price(new BigDecimal(BIG_DECIMAL_VALUE)).weight(WEIGHT).imageUrl(WWW_APPLE_5_COM)
                .build());

        stockRepository.save(Stock.builder().product(productOne).location(locationOne).quantity(QUANTITY_100).build());
        stockRepository.save(Stock.builder().product(productTwo).location(locationOne).quantity(QUANTITY_100).build());
        stockRepository.save(Stock.builder().product(productTwo).location(locationTwo).quantity(QUANTITY_2000).build());
        stockRepository.save(Stock.builder().product(productThree).location(locationThree).quantity(QUANTITY_100).build());
        stockRepository.save(Stock.builder().product(productFour).location(locationThree).quantity(QUANTITY_100).build());
