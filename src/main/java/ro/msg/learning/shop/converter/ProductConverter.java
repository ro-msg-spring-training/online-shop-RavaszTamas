...
public class ProductConverter implements BaseConverter<Product, ProductDto> {
  ...
  @Autowired Converter<ProductCategory, ProductCategoryDto> productCategoryDtoConverter;

  @Override
  public Product convertDtoToModel(ProductDto dto) {
    return Product.builder()
        .productCategory(productCategoryDtoConverter.convertDtoToModel(dto.getProductCategory()))
        .id(dto.getProductId())
